...
![](https://zccguagua.oss-cn-hangzhou.aliyuncs.com/images/blog/cover/ins_03.jpg "Image")
...
if __name__ == '__main__':
    ...
    itchat.run()
```
[代码及数据库链接](https://github.com/zccguagua/python_demo/blob/master/wechat/SendMessage.py)
